...
if(isset($_POST['register_button'])){
	...
	$_SESSION['reg_phone'] = $phone; //Stores email into session variable
	//Password
	$gender = strip_tags($_POST['reg_gender']); //Remove html tags
	$gender =($_POST['reg_gender']);

	$bdate = strip_tags($_POST['reg_bdate']); //Remove html tags
	$bdate =($_POST['reg_bdate']);

	$MHistory = strip_tags($_POST['reg_MHistory']); //Remove html tags
	$MHistory =($_POST['reg_MHistory']);
